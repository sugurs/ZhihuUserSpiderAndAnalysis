...
class ZhihuSpider(Spider):
    ...
    start_user = "dou-wei-52-22"#选定开始的大V
    user_url = "https://www.zhihu.com/api/v4/members/{user}?include={include}" #个人信息
    #用来请求个人信息
    user_query = 'following_count, business, columns_count, educations, favorite_count, favorited_count, following_columns_count, following_favlists_count, following_question_count, following_topic_count, hosted_live_count, locations, participated_live_count, pins_count, question_count, thank_from_count, thank_to_count, thanked_count, vote_from_count, vote_to_count, voteup_count, allow_message,is_followed,is_following,is_org,is_blocking,companies,answer_count,follower_count,articles_count,gender,badge[?(type=best_answerer)].topics'

    follows_url = "https://www.zhihu.com/api/v4/members/{user}/followees?include={include}&offset={offset}&limit={limit}"#大V关注列表
    follows_query = "data[*].following_count, business, columns_count, educations, favorite_count, favorited_count, following_columns_count, following_favlists_count, following_question_count, following_topic_count, hosted_live_count, locations, participated_live_count, pins_count, question_count, thank_from_count, thank_to_count, thanked_count, vote_from_count, vote_to_count, voteup_count, answer_count,articles_count,gender,follower_count,is_followed,is_following,badge[?(type=best_answerer)].topics"

    followees_url ='https://www.zhihu.com/api/v4/members/{user}/followers?include={include}&offset={offset}&limit={limit}' #大V的粉丝
    followees_query = 'data[*].following_count, business, columns_count, educations, favorite_count, favorited_count, following_columns_count, following_favlists_count, following_question_count, following_topic_count, hosted_live_count, locations, participated_live_count, pins_count, question_count, thank_from_count, thank_to_count, thanked_count, vote_from_count, vote_to_count, voteup_count, answer_count,articles_count,gender,follower_count,is_followed,is_following,badge[?(type=best_answerer)].topics'
